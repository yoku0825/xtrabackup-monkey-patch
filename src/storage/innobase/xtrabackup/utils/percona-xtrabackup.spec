%define xb_version_major  8
%define xb_version_minor  0
%define xb_version_patch  35
%define xb_version_extra  -31
%define xb_rpm_version_extra 31.1
%define xb_revision       55ec21d7
%if 0%{?rhel} == 8
